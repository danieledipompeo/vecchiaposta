...
\addtitle{Use Case 1}{Inserire Contenuti} 

%Scope: the system under design
\addfield{Scope:}{Utente}

%Level: "user-goal" or "subfunction"
\addfield{Level:}{Utente}

%Primary Actor: Calls on the system to deliver its services.
\addfield{Primary Actor:}{Amministratore}
...
\addfield{Postconditions:}{
  \item I contenuti multemediali sono stati aggiornati con successo}
%when multiple
%\additemizedfield{Preconditions:}{}
...
\addfield{Frequency of Occurrence:}{
  \item alta nella fase iniziale, bassa nelle fasi successive
}
